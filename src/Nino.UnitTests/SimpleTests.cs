...
{
    // Legacy custom serializer test removed - functionality now covered by TestNewCustomFormatterSystem()
...
#pragma warning restore CS0219 // Variable is assigned but its value is never used
    ...
    public void TestBoxedSerializationFailures()
    {
        ...
        var listWithAllLists = new List<object> { new List<int> { 1, 2 }, new List<int> { 3, 4 }, new List<int> { 5, 6 } };
        Assert.ThrowsException<Exception>(() =>
        {
        ...
        var mixedCollections = new List<object> { new List<int> { 1 }, new Dictionary<string, int> { { "a", 1 } }, new int[] { 1, 2 } };
        Assert.ThrowsException<Exception>(() =>
        {
    ...
    public void TestMultiDimensionalArrays()
    {
        ...
        Dictionary<string, int[,]> dictWith2DArraysResult = NinoDeserializer.Deserialize<Dictionary<string, int[,]>>(bytes);
